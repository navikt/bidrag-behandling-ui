...
import { QueryKeys, useMergeVirkningstidspunkt } from "@common/hooks/useApiData";
import { useQueryClient } from "@tanstack/react-query";

export const useOnMergeVirkningtidspunkt = () => {
    const queryClient = useQueryClient();
    const { behandlingId } = useBehandlingProvider();
    const mutation = useMergeVirkningstidspunkt();
