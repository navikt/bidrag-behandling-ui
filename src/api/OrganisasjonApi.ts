...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({
    ...
    this.instance = axios.create({
      ...
      baseURL:
        axiosConfig.baseURL ||
        "https://bidrag-organisasjon-feature.dev.intern.nav.no/bidrag-organisasjon",
    });
    this.secure = secure;
    this.format = format;
...
> extends HttpClient<SecurityDataType> {
  arbeidsfordeling = {
     ...
     * @secure
     */
    hentArbeidsfordelingGeografiskTilknytningEnhet: (
      data: HentEnhetRequest,
